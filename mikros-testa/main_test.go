...
var a app.App
var basePath = "/mikros-testa"
var query = "?microtestname=first%20micro%20test"
var queryUpdate = "?microtestname=first%20micro%20test1"
var payload = []byte(`{"microtestname": "first micro test","steps": [{"identifier": "identifiername","action": "click","data" : null}], "createdby" : "tester"}`)
var payloadUpdate = []byte(`{"microtestname": "first micro test1","steps": [{"identifier": "identifiername","action": "click","data" : null}], "createdby" : "tester"}`)
var badPayloadJson = []byte(`{"microtestname": "first micro test","steps": [{"identifier": "identifiername","action": "click","data" : null}], ..."createdby" : "tester"}`)
