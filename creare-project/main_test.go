...
var a app.App
var basePath = "/creare-project"
var query = "?projectname=missionimpossible"
var queryUpdate = "?projectname=missionimpossible1"

var payload = []byte(`{"projectname": "missionimpossible", "username": "tester", "password" : "tester"}`)
var payloadUpdate = []byte(`{"projectname": "missionimpossible1", "username": "tester1", "password" : "tester"}`)
var badPayloadJson = []byte(`{"projectname": "missionimpossible", "username": ..."tester", "password" : "tester"}`)
