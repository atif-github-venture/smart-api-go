...
import (
	...
	"log"
	"net/http"
	"smartapigo/creare-project/app/handler"
	"smartapigo/creare-project/app/model"
...
func (a *App) setRouters() {
	a.Get("/creare-project", a.GetObjectRepos)
	a.Post("/creare-project", a.AddObject)
	a.Put("/creare-project", a.UpdateObject)
	a.Delete("/creare-project", a.DeleteObject)
}
