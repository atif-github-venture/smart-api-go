...
import (
	...
	"log"
	"net/http"
	"smartapigo/identifier-repository/app/handler"
...
func (a *App) setRouters() {
	a.Get("/identifier-repository", a.GetObjectRepos)
	a.Post("/identifier-repository", a.AddObject)
	a.Put("/identifier-repository", a.UpdateObject)
	a.Delete("/identifier-repository", a.DeleteObject)
}
