...
import (
	...
	"log"
	"net/http"
	"smartapigo/test-config/app/handler"
...
func (a *App) setRouters() {
	a.Get("/test-config", a.GetObject)
	a.Post("/test-config", a.AddObject)
	a.Put("/test-config", a.UpdateObject)
	a.Delete("/test-config", a.DeleteObject)
}
