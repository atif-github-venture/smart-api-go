...
import (
	...
	"log"
	"net/http"
	"smartapigo/testa-configurare/app/handler"
...
func (a *App) setRouters() {
	a.Get("/testa-configurare", a.GetObject)
	a.Post("/testa-configurare", a.AddObject)
	a.Put("/testa-configurare", a.UpdateObject)
	a.Delete("/testa-configurare", a.DeleteObject)
}
